    ...
    return(
      <>
        <div className="absolute p-5">
          <button 
            className="p-2 bg-white border border-emerald-600 rounded-lg shadow-md hover:bg-emerald-50" 
            type="button" 
        ...
        {/* Drawer */}
        <div 
          className={`fixed top-16 left-0 z-40 h-[calc(100vh-4rem)] p-4 m-2 overflow-y-auto transition-transform duration-300 bg-white w-80 rounded-lg shadow-lg ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
        >
